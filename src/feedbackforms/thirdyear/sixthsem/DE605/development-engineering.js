...
function DevelopmentEngineering() {
    ...
    survey.onComplete.add((sender, options) => {
        ...
        const newSurveyRef = ref(database, `ThirdYear/SixthSemester/BTHM605(A):Development Engineering/${prn}`); // Use PRN as key
        set(newSurveyRef, {
            email,
            fullname,
            ratings,
...
export default DevelopmentEngineering;
