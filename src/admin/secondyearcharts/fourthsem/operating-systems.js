...
function OperatingSystemsChart () {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const snapshot = await get(ref(database, 'SecondYear/FourthSemester/BTCOC402:Operating Systems'));
                if (snapshot.exists()) {
            ...
            chartRef.current = new Chart(ctx, {
                ...
                options: {
                    plugins: {
                        title: {
                            display: true,
                            text: "BTCOC402:Operating Systems Ratings",
                            font: {
    ...
    const handleDownload = () => {
        ...
        XLSX.writeFile(workbook, "BTCOC402:Operating Systems Feedback.xlsx");
    };
    ...
    return (
        <div style={{ width: "100%", height: "500px" }}>
            <canvas id="operatingsystemsChart"></canvas>
