...
function EconomicsManagementChart() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const snapshot = await get(ref(database, 'ThirdYear/FifthSemester/BTHM505(A):Economics and Management'));
                if (snapshot.exists()) {
...
export default EconomicsManagementChart;
